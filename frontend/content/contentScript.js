chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    if(request.action === "EXTRACT_BASIC") { // Basic 정보 추출
        ...
        // 상품명
        const name = document.querySelector('.prod-buy-header');
        ...
        // 리뷰 수
        const reviewCount = document.querySelector('.sdp-review__average__total-star__info-count');
        ...
        // 리뷰 정보
        const reviewInfo=document.querySelector('.sdp-review__article__order__star__all');

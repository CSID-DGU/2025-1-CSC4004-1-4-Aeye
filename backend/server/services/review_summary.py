...
def summarize_review_info(review_data):
    prompt = f"""
        사용자들의 평균 만족도는 \"{review_data["average_grade"]}\"입니다. 항목과 %를 있는 그대로 보여주십시오.
        리뷰정보는\"{review_data["review_info"]}\"입니다. 나쁨부터 최고 순서로 되어 있는데, 각 상태 왼쪽에 있는게 그 상태의 숫자입니다. 출력할때는 상태와 그 상태의 갯수를 연결지어서 보여주십시오. 예를 들어 "최고: 23개 좋음: 12개 보통: 31개 별로: 20개 나쁨: 50개"의 형식으로 보여주십시오.
        대표리뷰는 \"{review_data["comment_data"]}\"입니다. 이를 3~4줄로 요약해서 보여주십시오.
        이 정보를 토대로
        평균 만족도:\n리뷰 정보:\n대표 리뷰:\n형태로 보여주십시오.
        """ 
    try:
                    ...
                    "function": {
                        ...
                        "parameters": {
                            ...
                            "properties": {
                                ...
                                "review_info" : {"type" : "string", "description": "리뷰 정보"},
                                "comment_data" : {"type" : "string", "description": "대표 리뷰"}
                            },
                             "required": [ "average_grade","review_info","comment_data"]
        ...
        if tool_calls and len(tool_calls) > 0:
            ...
            return {
                ...
                "review_info" :product_info.get("review_info"),
